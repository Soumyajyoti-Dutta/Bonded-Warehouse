			...
			<c:forEach items="${docsbyId}" var="doc" varStatus="loop">
				...
				<table class="table table-bordered">
					...
					<tr>
						...
						<td>
							<div class="col-xs-8">
								<input class="form-control" name="destination" id="destination" value="${doc.getSource()}" type="text">
							</div>
						</td>
					</tr>
					<tr>
				...
				<table id="dataTable" class="table table-bordered">
					...
					<tr>
						<td><input type="text" name="txtbox_${loop.index + 1}_1" value="${item.getName()}" readonly/></td>
						<td><input type="text" name="txtbox_${loop.index + 1}_2" value="${item.getQuantity()}" readonly/></td>
						<td><input type="text" name="txtbox_${loop.index + 1}_3" value="${item.getDescription()}" readonly/></td>
						<td><input type="text" name="txtbox_${loop.index + 1}_4" value="${item.getWeightvolume()}" readonly/></td>
					</tr>
					</c:forEach>
				</table>
				<input
				...
				<input type="hidden" name="tableRowCount" value="${fn:length(items)}" id="tableRowCount" /> 
