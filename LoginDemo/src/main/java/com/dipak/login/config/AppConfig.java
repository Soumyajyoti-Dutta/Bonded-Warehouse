package com.dipak.login.config;
...
import com.dipak.login.dao.LoginDaoImpl;
import com.dipak.login.dao.RejectionCodeDao;
import com.dipak.login.dao.RejectionCodeDaoImpl;;

@Configuration
@EnableWebMvc
@ComponentScan(basePackages = "com.dipak.login")
