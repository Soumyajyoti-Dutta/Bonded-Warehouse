...
function updateStatuss(dId, dSource, dDestination, dStatus) {
    ...
    if(dStatus == "Processed"){    	
    	...
    	document.getElementById("status").options[1] = null;
}  
...
<div class="panel-heading">
	...
	<div class="panel panel-success">
		<div class="panel-heading">
			<h3  align="center">Custom Party</h3>
			<div class="container-fluid" style="float:right;margin-top:-49px;">
...
<!-- 												<option value="Reason3">Reason code 3</option> -->
									...
									<input type="HIDDEN" id="dStatus" value="" readonly="readonly" class="form-control" />
