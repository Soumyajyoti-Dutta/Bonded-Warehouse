		...
		<c:if test="${param.statusUpdate == 'success' || statusUpdate == 'success'}">
			...
			<c:if test="${highpriorityDocListCount!=''}">
				<div class="alertHigh alert-info">
						<strong><img title="High Alert" style="width:20px; height:20px;" src="./resources/img/alert.gif"/><a href="./customLogin">  Number of truck(s) arriving to custom: ${highpriorityDocListCount}</a></strong>
				</div>
			</c:if>
			<div class="container">
				<c:choose>
