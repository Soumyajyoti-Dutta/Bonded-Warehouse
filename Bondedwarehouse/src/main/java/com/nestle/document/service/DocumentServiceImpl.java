...
public class DocumentServiceImpl implements DocumentService {
	...
	public Status countStatus() {
		...
		status.setInitiated(testAPI.interactWithLedger("recordCount", "", "Initial", "", "", ""));
	...
	public List<Document> gethighPriorityDoument() {
		...
		for (JsonElement doc : docArray) {
			Document orderDocument = myGson.fromJson(doc, Document.class);
			docList.add(orderDocument);
			System.out.println("Highpriority1 == " + orderDocument.getDocumentId());
			System.out.println("Highpriority2 == " + orderDocument.getSource());
			System.out.println("Highpriority3 == " + orderDocument.getDestination());
			System.out.println("Highpriority4 == " + orderDocument.getStatus());
		}
